...
void PYBIND11_MODULE_IMPL(py::module_ m)
{
    ...
    m.def("make_graph_db", +[](extensions::ptr_t<extensions::graphdb::schema::PyTransactionNode> parent, extensions::graph::feature::index_t graph)
          { return extensions::graph::Graph::make_graph(parent->txn(), graph); });
}
